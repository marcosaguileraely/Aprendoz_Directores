...
public class Certificadosimple extends com.wavemaker.runtime.javaservice.JavaServiceSuperClass {
     public DownloadResponse getReport(String idPersonacs, String sycs, String com1, String com2) throws Exception { 
       ...
       try {
        System.out.println("Ingreso al TRY");
          ...
          URL fileUrl = this.getClass().getResource("CertificadoSimple.jasper");
          ...
          ret.setContentType(mimeFileTypeMap.getContentType("CertificadoSimple.jasper"));
