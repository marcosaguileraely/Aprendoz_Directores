...
public class c316 extends com.wavemaker.runtime.javaservice.JavaServiceSuperClass {
   public DownloadResponse getReport(String idp, String idsy) throws Exception {
  
       //convirtiendo String a Integer
       int idpersona= Integer.valueOf(idp);
       ...
       try {
          ...
          parameters.put("CODIGO", idpersona);
          parameters.put("idsy", idsy);

          System.out.println("capturados!");
          //direccion del archivo Jasper
          URL fileUrl = this.getClass().getResource("reporte_316.jasper");
          ...
          ret.setContentType(mimeFileTypeMap.getContentType("reporte_316.jasper"));
          ret.setContents(new ByteArrayInputStream(out.toByteArray()));
          ret.setFileName("Estado Total por Estudiante "+idp+"-"+idsy+".pdf");
