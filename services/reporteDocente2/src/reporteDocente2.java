...
public class reporteDocente2 extends com.wavemaker.runtime.javaservice.JavaServiceSuperClass{
...
/*public DownloadResponse getReport(String Asignatura, String Curso) throws Exception {*/
       ...
       try {
          ...
          URL fileUrl = this.getClass().getResource("reporte2.jasper");
          
          //para cargar el jasper
          JasperReport report3 = (JasperReport)JRLoader.loadObject(fileUrl);
          
          //cargar conexion de la base de datos al reporte y el archivo Jasper
          JasperPrint jasperPrint = JasperFillManager.fillReport(report3,parameters,session.connection());
          ...
          ret.setContentType(mimeFileTypeMap.getContentType("reporte2.pdf"));
          ret.setContents(new ByteArrayInputStream(out.toByteArray()));
          ret.setFileName("AprendozReporteDocentes.pdf");
