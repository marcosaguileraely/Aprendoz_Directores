...
public class gDimensionComprension extends com.wavemaker.runtime.javaservice.JavaServiceSuperClass {
     public DownloadResponse getReport(String idnivel, String idgrado, String idasignatura) throws Exception { 
      ...
      //     parameters.put("comentarioInferior", com2);
          ...
          URL fileUrl = this.getClass().getResource("GraficaDimensionComprension.jasper");
          ...
          ret.setContentType(mimeFileTypeMap.getContentType("GraficaDimensionComprension.jasper"));
          ret.setContents(new ByteArrayInputStream(out.toByteArray()));
          ret.setFileName("reporteDimensionComprension.pdf");
