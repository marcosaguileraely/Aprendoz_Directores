...
public class c314 extends com.wavemaker.runtime.javaservice.JavaServiceSuperClass {
    
    public DownloadResponse getReport(String idcodigo, String IDsy) throws Exception {
              System.out.println(idcodigo);
              System.out.println(IDsy);
         int codigoid= Integer.valueOf(idcodigo);
         int idsy=Integer.valueOf(IDsy);
       ...
       try {
          ...
          parameters.put("codigo", codigoid);
          parameters.put("idsy", idsy);
          
          //direccion del archivo Jasper
          URL fileUrl = this.getClass().getResource("314.jasper");
          ...
          ret.setContentType(mimeFileTypeMap.getContentType("314.jasper"));
          ret.setContents(new ByteArrayInputStream(out.toByteArray()));
          ret.setFileName("ReporteCalificacion.pdf");
