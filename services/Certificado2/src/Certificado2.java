...
public class Certificado2 extends com.wavemaker.runtime.javaservice.JavaServiceSuperClass {
  public DownloadResponse getReport(String idPersona, String sy, String coment1, String coment2) throws Exception { 
        System.out.println(idPersona);
        System.out.println(sy);
        System.out.println(coment1);
        System.out.println(coment2);
       ...
       try {
        System.out.println("Ingreso al TRY");
          ...
          Map parameters= new HashMap();
           ...
           parameters.put("comentarioSuperior", coment1);
           parameters.put("comentarioInferior", coment2);
           System.out.println("captura parametros");      
          //direccion del archivo Jasper
          URL fileUrl = this.getClass().getResource("Certificado2.jasper");
          ...
          ret.setContentType(mimeFileTypeMap.getContentType("Certificado2.jasper"));
          ret.setContents(new ByteArrayInputStream(out.toByteArray()));
          ret.setFileName("CertificadoCompletoAprendoz.pdf");
