...
public class c3119 extends com.wavemaker.runtime.javaservice.JavaServiceSuperClass {
    public DownloadResponse getReport(String idCurso, String fecha, String Curso) throws Exception {
       ...
       try {
        ...
        //  parameters.put("periodo", idperiodo);
          ...
          ret.setContentType(mimeFileTypeMap.getContentType("3.1.19.a.jasper"));
          ret.setContents(new ByteArrayInputStream(out.toByteArray()));
          ret.setFileName("Reporte Asistencia para el Curso "+Curso+".pdf");
