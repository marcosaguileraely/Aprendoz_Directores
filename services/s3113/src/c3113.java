...
public class c3113 extends com.wavemaker.runtime.javaservice.JavaServiceSuperClass {
    
    public DownloadResponse getReport(String idsy) throws Exception {
       ...
       try {
          ...
          URL fileUrl = this.getClass().getResource("3133.jasper");
          ...
          ret.setContentType(mimeFileTypeMap.getContentType("3133.jasper"));
          ret.setContents(new ByteArrayInputStream(out.toByteArray()));
          ret.setFileName("CatalogoAsignaturas.pdf");
