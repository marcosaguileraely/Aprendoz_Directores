...
public class c3112 extends com.wavemaker.runtime.javaservice.JavaServiceSuperClass {
    
    public DownloadResponse getReport(String idsy, String idgrado) throws Exception {
       ...
       try {
          ...
          parameters.put("idSY", sy);
          parameters.put("idGR", idgr);
          
          //direccion del archivo Jasper
          URL fileUrl = this.getClass().getResource("3112a.jasper");
          ...
          ret.setContentType(mimeFileTypeMap.getContentType("3112a.jasper"));
          ret.setContents(new ByteArrayInputStream(out.toByteArray()));
          ret.setFileName("PlanEstudioAsignaturas.pdf");
