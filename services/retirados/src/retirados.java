...
public class retirados extends com.wavemaker.runtime.javaservice.JavaServiceSuperClass {
    
    public DownloadResponse getReport(String fr1, String fr2) throws Exception {
          System.out.println(fr1); 
              System.out.println(fr2); 
         Long dtnum=Long.valueOf(fr1);
           Date dt1= new Date(dtnum);
           //parametro 2
            Long dtnum2=Long.valueOf(fr2);
     ...
     //   System.out.println(dt2);
       ...
       try {
          ...
          parameters.put("fecha1", dt1);
          parameters.put("fecha2", dt2);
          
          //direccion del archivo Jasper
          URL fileUrl = this.getClass().getResource("alumnosRetirados.jasper");
          ...
          ret.setContentType(mimeFileTypeMap.getContentType("alumnosRetirados.jasper"));
          ret.setContents(new ByteArrayInputStream(out.toByteArray()));
          ret.setFileName("InformeEstudiantesRetirados.pdf");
