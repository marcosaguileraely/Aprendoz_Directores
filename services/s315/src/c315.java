...
public class c315 extends com.wavemaker.runtime.javaservice.JavaServiceSuperClass {
    ...
    public DownloadResponse getReport() throws Exception {
       ...
       try {
          ...
          URL fileUrl = this.getClass().getResource("315.jasper");
          ...
          ret.setContentType(mimeFileTypeMap.getContentType("315.jasper"));
          ret.setContents(new ByteArrayInputStream(out.toByteArray()));
          ret.setFileName("Libro.pdf");
