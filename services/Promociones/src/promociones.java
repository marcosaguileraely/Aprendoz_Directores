...
public class promociones extends com.wavemaker.runtime.javaservice.JavaServiceSuperClass{
...
public DownloadResponse getReport(String curso1, String curso2) throws Exception { 
       ...
       System.out.println("Ingreso al TRY");
          ...
          URL fileUrl = this.getClass().getResource("promociones.jasper");
          ...
          ret.setContentType(mimeFileTypeMap.getContentType("promociones.jasper"));
          ret.setContents(new ByteArrayInputStream(out.toByteArray()));
          ret.setFileName("reportePromociones.pdf");
