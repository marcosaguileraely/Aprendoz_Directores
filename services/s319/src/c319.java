...
public class c319 extends com.wavemaker.runtime.javaservice.JavaServiceSuperClass {
     public DownloadResponse getReport(String c1, String c2, String idp) throws Exception {
       ...
       try {
          ...
          URL fileUrl = this.getClass().getResource("3.1.8.all_num.jasper");
          ...
          ret.setContentType(mimeFileTypeMap.getContentType("3.1.8.all_num.jasper"));
          ret.setContents(new ByteArrayInputStream(out.toByteArray()));
          ret.setFileName("Matriz de calificacion por Curso(s)[Puntaje].pdf");
