...
public class Grado {
    ...
    public Grado(Integer idGrado, Nivel nivel, String grado, String grade, String gradoSapiens, Set<com.aprendoz_test.data.InscAlumArea> inscAlumAreas, Set<com.aprendoz_test.data.Asignatura> asignaturas, Set<com.aprendoz_test.data.Costos> costoses, Set<com.aprendoz_test.data.Curso> cursos) {
        this.idGrado = idGrado;
        this.nivel = nivel;
        this.grado = grado;
        this.grade = grade;
