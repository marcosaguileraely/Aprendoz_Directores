...
public class Costos {
    ...
    public Costos(Integer idCosto, Grado grado, Sy sy, String codigo, String nombreProducto, String descripcion, Double valor, Boolean nuevo, Boolean obligatorio, Boolean positivo, Boolean anual, Set<com.aprendoz_test.data.InscAlumCosto> inscAlumCostos) {
        this.idCosto = idCosto;
        this.grado = grado;
        this.sy = sy;
        this.codigo = codigo;
