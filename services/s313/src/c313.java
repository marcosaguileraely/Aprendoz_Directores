...
public class c313 extends com.wavemaker.runtime.javaservice.JavaServiceSuperClass {
   ...
   public DownloadResponse getReport(String idsy) throws Exception {
       ...
       try {
          ...
          ret.setFileName("Detalles Grupo_familiar Matriculados y Activos"+idsy+".pdf");
