...
public class  gInteligencia  extends com.wavemaker.runtime.javaservice.JavaServiceSuperClass {
     public DownloadResponse getReport(String idnivel, String idgrado, String idasignatura) throws Exception { 
      ...
      //     parameters.put("comentarioInferior", com2);
          ...
          URL fileUrl = this.getClass().getResource("GraficaInteligencia.jasper");
          ...
          ret.setContentType(mimeFileTypeMap.getContentType("GraficaInteligencia.jasper"));
          ret.setContents(new ByteArrayInputStream(out.toByteArray()));
          ret.setFileName("reporteGraficoInteligencia.pdf");
